...
I'm a multidisciplinary developer specializing in **Full Stack Development**, **DevOps Engineering**, and **Game Development**. With expertise across multiple domains, I create robust web applications, implement efficient CI/CD pipelines, and design immersive gaming experiences.
  ...
  <tr>
    <td width="50%">
      ...
      <div align="center">  
        ...
        <p><strong>React.js, Vite, Tailwind CSS, AOS</strong></p>
        <p>Modern single-page restaurant website with dark/light mode toggle, smooth animations, and responsive design implementing industry best practices.</p>
      </div>
    </td>
    <td width="50%">
      ...
      <div align="center">  
        ...
        <p><strong>Kubernetes, Flask, Prometheus, Grafana</strong></p>
        <p>Complete monitoring solution for Kubernetes clusters featuring metrics collection, visualization dashboards, and alerting capabilities.</p>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <div align="center">  
        ...
        <p><strong>Docker, Python, Telegram API</strong></p>
        <p>Containerized Telegram bot with optimized Docker configuration, demonstrating best practices for application containerization and deployment.</p>
      </div>
    </td>
    <td width="50%">
      ...
      <div align="center">  
        ...
        <p><strong>Jenkins, Node.js, CI/CD</strong></p>
        <p>Comprehensive CI/CD pipeline for Node.js applications featuring automated testing, dependency scanning, and multi-environment deployments.</p>
      </div>
    </td>
  </tr>
</table>
...
Legend: ✅ Mastered | 🔄 Currently Learning | 📆 Planned

## 🔍 What I'm Looking For

- **Collaborative Projects** in web development, DevOps or game development
- **Open Source Contributions** where I can leverage my diverse skill set
